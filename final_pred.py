...
class Application:
    ...
    def __init__(self):
        ...
        self.root.configure(bg="#ADD8E6")   # any color


        self.panel = tk.Label(self.root, bg="#ADD8E6")
        self.panel.place(x=100, y=3, width=480, height=640)

        self.panel2 = tk.Label(self.root, bg="#ADD8E6")  # initialize image panel
        self.panel2.place(x=700, y=115, width=400, height=400)

        self.T = tk.Label(self.root, bg="#ADD8E6")
        self.T.place(x=60, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Times New Roman", 30, "bold"))

        self.panel3 = tk.Label(self.root, bg="#ADD8E6")  # Current Symbol
        self.panel3.place(x=280, y=585)

        self.T1 = tk.Label(self.root, bg="#ADD8E6")
        self.T1.place(x=10, y=580)
        self.T1.config(text="Character :", font=("Times New Roman", 30,"bold"))

        self.panel5 = tk.Label(self.root, bg="#ADD8E6")  # Sentence
        self.panel5.place(x=260, y=632)

        self.T3 = tk.Label(self.root, bg="#ADD8E6")
        self.T3.place(x=10, y=632)
        self.T3.config(text="Sentence :", font=("Times New Roman", 30, "bold"))

        self.T4 = tk.Label(self.root, bg="#ADD8E6")
        self.T4.place(x=10, y=700)
        self.T4.config(text="Suggestions :", fg="green", font=("Times New Roman", 30, "bold"))
